...
public class WinNavigationBarView extends LinearLayout {
    final static boolean DEBUG = false;
    final static String TAG = "OSWin/WinNavigationBarView";
    ...
    private final WinNavigationBarTransitions mBarTransitions;
    ...
    public WinNavigationBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mBarTransitions = new WinNavigationBarTransitions(this);
    }

    public WinBarTransitions getBarTransitions() {
    ...
    */
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        pw.println("WinNavigationBarView {");
