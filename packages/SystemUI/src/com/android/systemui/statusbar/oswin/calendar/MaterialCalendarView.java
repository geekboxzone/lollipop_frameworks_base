...
import com.android.systemui.statusbar.oswin.calendar.format.DayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
     ...
     */
    public static final int DEFAULT_TILE_SIZE_DP = 35;
    ...
    private int DEFAULT_ARROW_COLOR = Color.WHITE;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            setArrowColor(a.getColor(
                    R.styleable.MaterialCalendarView_mcv_arrowColor, DEFAULT_ARROW_COLOR));
            Drawable leftMask = a.getDrawable(
                    R.styleable.MaterialCalendarView_mcv_leftArrowMask);
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.win_metro_month_prev);
            }
            setLeftArrowMask(leftMask);
            Drawable rightMask = a.getDrawable(
                    R.styleable.MaterialCalendarView_mcv_rightArrowMask);
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.win_metro_month_next);
            }
    ...
    private void setupChildren() {
        ...
        buttonPast.setImageResource(R.drawable.win_metro_month_prev);

        LinearLayout.LayoutParams layout = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1);
        layout.setMargins(padding, padding, padding, padding);
        topbar.addView(buttonPast,layout);
        ...
        buttonFuture.setImageResource(R.drawable.win_metro_month_next);
        topbar.addView(buttonFuture, layout);
    ...
    /**
     * Set a {@linkplain package com.android.systemui.statusbar.oswin.calendar.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see package com.android.systemui.statusbar.oswin.calendar.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(package com.android.systemui.statusbar.oswin.calendar.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain package com.android.systemui.statusbar.oswin.calendar.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see package com.android.systemui.statusbar.oswin.calendar.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(package com.android.systemui.statusbar.oswin.calendar.format.TitleFormatter)
     */
     ...
     */
    protected void onDateUnselected(@NonNull CalendarDay date) {
