...
public final class WinNavigationBarTransitions extends WinBarTransitions {

    private static final int CONTENT_FADE_DURATION = 200;

    private final WinNavigationBarView mView;
    ...
    public WinNavigationBarTransitions(WinNavigationBarView view) {
