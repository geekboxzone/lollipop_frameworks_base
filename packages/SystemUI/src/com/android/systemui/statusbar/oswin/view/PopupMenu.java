...
public class PopupMenu {
    ...
    public PopupMenu(Context context) {
        ...
        setContentView(mInflater.inflate(R.layout.metro_popup_menu, null));
    }

    public PopupMenu(Context context, ListView list) {
        mContext = context;
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mItems = new ArrayList<MenuItem>();
        mListOnly = list;
    ...
    public void show() {
        if(null != mListOnly){
            mListOnly.setVisibility(View.VISIBLE);
            MenuItemAdapter adapter = new MenuItemAdapter(mContext, mItems);
            mListOnly.setAdapter(adapter);
            mListOnly.setOnItemClickListener(new OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position,
                    ...
                    mListOnly.setVisibility(View.INVISIBLE);
                }
            });
        }else{
            show(null);
    ...
    private class MenuItemAdapter extends ArrayAdapter<MenuItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.metro_popup_item, null);
