...
import com.android.systemui.statusbar.oswin.calendar.MaterialCalendarView.ShowOtherDates;
...
import static com.android.systemui.statusbar.oswin.calendar.MaterialCalendarView.SHOW_DEFAULTS;
import static com.android.systemui.statusbar.oswin.calendar.MaterialCalendarView.showOtherMonths;
...
class MonthView extends ViewGroup implements View.OnClickListener {
    ...
    public MonthView( MaterialCalendarView view, CalendarDay month, int firstDayOfWeek) {
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        final int measureTileSize = (specWidthSize - 14) / DEFAULT_DAYS_IN_WEEK;
